...
function pg1func(op){
    ...
    enviar.onclick= function(){if(name.value!="" && phone.value!=""){document.getElementById("contact_form").submit(); contact_info.name= name.value; contact_info.phone_no=phone.value; APIDataCall(contact_info);
